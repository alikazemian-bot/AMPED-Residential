...
Agent-based Model for Predicting Electricity Demand
...
│
└── 251110 Final_version2_BKW.docx
    └─ Manuscript describing the model framework, validation, and applications
...
Citation
If using AMPED-Residential in academic or policy work, please cite:
